    ...
    return (
        <footer className="bg-black text-white py-[60px] lg:py-[120px]">
            <div className="max-w-[1380px] mx-auto px-6 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-20 mb-12">
                    {/* Column A - Contact Info */}
                    <div className="space-y-4">
                        <h3 className="text-[14px] lg:text-[16px] font-medium text-white mb-2">
                            AI - Marketing Automation Agency
                        </h3>
                        <div className="space-y-3">
                            <div className="text-[13px] lg:text-[14px] text-gray-200">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-center text-[13px] lg:text-[14px] text-gray-200 hover:text-white transition-colors">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-[13px] lg:text-[14px] text-gray-200 mb-2">
                        ...
                        <div className="space-y-3">
                            <input
                                ...
                                className="w-full px-3 py-2.5 bg-gray-800 border border-gray-700 rounded-3xl text-white placeholder-gray-400 focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 transition-colors"
                            />
