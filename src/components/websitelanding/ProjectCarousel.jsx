...
const ProjectCarousel = () => {
    ...
    const portfolioItems = [
        {
            id: 1,
            image: '/assets/images/website&landingpage/hero1.png',
            gradient: 'from-[#A4FCFF]/20 to-[#C8A4FE]/20'
        },
        {
            id: 2,
            image: '/assets/images/website&landingpage/hero2.png',
            gradient: 'from-[#C8A4FE]/20 to-[#5a37c0]/20'
        },
        {
            id: 3,
            image: '/assets/images/website&landingpage/hero3.png',
            gradient: 'from-[#A4FCFF]/20 to-[#5a37c0]/20'
        },
        {
            id: 4,
            image: '/assets/images/website&landingpage/hero4.png',
