...
import { ChevronRight, Users, Target, Link, Bot, Clock, TrendingUp, Network, Zap } from 'lucide-react';
                        ...
                        return (
                            <div key={index} className="group relative">
                                ...
                                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 hidden md:block">
                                    <div className="w-12 h-12 bg-white border-2 border-gray-200 rounded-full flex items-center justify-center shadow-lg group-hover:border-[#5534bb] transition-all duration-300">
                                ...
                                <div className="bg-white border-2 border-black rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 group-hover:scale-[1.02]">
                                    <div className="grid md:grid-cols-2">
                                        ...
                                        <div className="bg-gradient-to-br from-gray-900 to-black p-5 md:p-7 relative overflow-hidden">
                                            {/* Decorative elements */}
                                            <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-[#5534bb]/10 to-transparent rounded-full blur-xl"></div>
                                            <div className="absolute bottom-0 left-0 w-16 h-16 bg-gradient-to-tr from-[#2faeec]/10 to-transparent rounded-full blur-xl"></div>

                                            <div className="relative z-10">
                                                <div className="flex justify-center mb-4">
                                                    <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center shadow-lg backdrop-blur-sm">
                                                        <PainIcon className="w-6 h-6 text-white" />
                                                    </div>
                                                </div>
                                        ...
                                        {/* Solution - Right Side */}
                                        <div className="bg-gradient-to-br from-white to-gray-50 p-5 md:p-7 relative overflow-hidden">
                                            {/* Decorative elements */}
                                            ...
                                            <div className="relative z-10">
                                                <div className="flex justify-center mb-4">
                                                    <div className="w-12 h-12 bg-gray-100 rounded-xl flex items-center justify-center shadow-lg">
                                                        <SolutionIcon className="w-6 h-6 text-[#5534bb]" />
                                                    </div>
                                                </div>
                                                <div className="text-center">
                                                    ...
                                                    <span className="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-[#5534bb]/10 to-[#2faeec]/10 text-[#5534bb] text-[13px] lg:text-[15px] font-medium rounded-full border border-[#5534bb]/20 hover:from-[#5534bb]/20 hover:to-[#2faeec]/20 transition-all duration-300">
