...
const GoogleAdsProcess = () => {
    const processSteps = [
        {
            id: 1,
            title: "1. Tiếp nhận & Tư vấn mục tiêu",
            steps: [
        ...
        {
            id: 2,
            title: "2. Phân tích & Đề xuất chiến lược",
            steps: [
        ...
        {
            id: 3,
            title: "3. Thiết lập hệ thống quảng cáo",
            steps: [
        ...
        {
            id: 4,
            title: "4. Triển khai & Theo dõi chiến dịch",
            steps: [
        ...
        {
            id: 5,
            title: "5. Báo cáo & Tối ưu hiệu suất",
            steps: [
        ...
        {
            id: 6,
            title: "6. Đánh giá và gia hạn hợp tác",
            steps: [
    ...
    const Card = ({ step }) => {
        ...
        return (
            <div className={`border-2 rounded-lg p-6 transition-all shadow-md duration-300 flex flex-col h-full ${
                isLastCard
                ...
                <div className="flex-1 flex flex-col justify-between">
                    <div className="space-y-4">
                        {step.steps.map((stepText, index) => {
                            ...
                            return (
                                <div key={index}>
                                    <div className={`flex items-start gap-2 p-4 rounded-lg border transition-colors duration-200 min-h-[80px] ${
                                        isLastCard
                                            ? isLastStep
                                        ...
                                        <div className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${
                                            isLastCard
                                                ? isLastStep
                                                    ? 'bg-black text-white' // Black circle with white text for last step in black card
                                                    : 'bg-[#c08dfe] text-white'
                                                : isLastStep && !isCard1
                                                    ? 'bg-white text-black' // White circle with black text for last step in white card (except card 1)
                                                    : 'bg-[#c08dfe] text-white'
                                        }`}>
